...
class BbvaTarjetasScraper(BbvaScraper):
    ...
    def _import_resumen(
        ...
        # Determinar mes_resumen real (desde las transacciones parseadas, no desde fechaCierre)
        # y chequear si ya fue importado manualmente con otro nombre de archivo.
